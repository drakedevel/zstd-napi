...
Prebuilds are provided for GNU/Linux x64, macOS x64 and arm64, and Windows x64. GNU/Linux prebuilds are linked against Glibc 2.28, which is the same version required by official Node.js 18+ builds.
