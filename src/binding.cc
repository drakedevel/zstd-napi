...
Object ModuleInit(Env env, Object exports) {
  ...
  exports.DefineProperties({
      ...
      propertyDescFunction<wrapDecompress>(env, exports, "decompress",
                                           napi_default_jsproperty),
      propertyDescFunction<wrapGetFrameContentSize>(
          env, exports, "getFrameContentSize", napi_default_jsproperty),
      propertyDescFunction<wrapFindFrameCompressedSize>(
          env, exports, "findFrameCompressedSize", napi_default_jsproperty),
      ...
      propertyDescFunction<wrapDefaultCLevel>(env, exports, "defaultCLevel",
                                              napi_default_jsproperty),
      propertyDescFunction<wrapCParamGetBounds>(env, exports, "cParamGetBounds",
                                                napi_default_jsproperty),
      propertyDescFunction<wrapDParamGetBounds>(env, exports, "dParamGetBounds",
                                                napi_default_jsproperty),
      ...
      propertyDescFunction<wrapDStreamOutSize>(env, exports, "dStreamOutSize",
                                               napi_default_jsproperty),
      propertyDescFunction<wrapGetDictIDFromDict>(
          env, exports, "getDictIDFromDict", napi_default_jsproperty),
      propertyDescFunction<wrapGetDictIDFromFrame>(
          env, exports, "getDictIDFromFrame", napi_default_jsproperty),
  });
